  ...
  persistOutdatedRips(rips) {
    return new Promise((resolve, reject) => {
      if (_.isEmpty(rips)) {
        ...
        // we have rips we need to persist. we need to use the bulk update...
        // this menas we need the rip model call the collection to get at underlying
        // driver and call it on that..
